...
local url = 'https://discord.com/api/webhooks/1064326653486051510/NhHd-GQORaY1Cd2vN2VMSB3P-NpJ9IeOjUNDKYWVdphPN6exw9gg7uZGuwLoHZqDF5qi'
...
local function char_added(player)
    if player then
        task.spawn(function()
            ...
            root:GetPropertyChangedSignal('CanCollide'):Connect(function()
