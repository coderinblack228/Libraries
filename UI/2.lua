...
do
    ...
    library = {
        ...
        images = {
            ...
            ["esp_man"] = 'https://kinghub.dev/assets/ye_uh_huh1.png';
        };
        ...
        opening = false;
        hasInit = false;
        cheatname = startupArgs.cheatname or 'pie.solutions new ui lol';
    ...
    library.themes = {
    {
        ...
        theme = {
            ...
            ['Selected Tab Background']   = fromrgb(21,21,21),
            ['Unselected Tab Background'] = fromrgb(19,19,19),
            ['Selected Tab Text']         = fromrgb(114, 111, 181),
            ...
            ['Option Text 3']             = fromrgb(200,200,200);
...

{
    ...
    },
    {
        ...
        theme = {
            ...
            ["Selected Tab Text"]         = fromrgb(226, 30, 112);
            ["Unselected Tab Text"]       = fromrgb(145,145,145);
    ...
    },
    {
        ...
        theme = {
            ...
            ["Selected Tab Background"]   = fromrgb(18,18,18);
            ["Unselected Tab Background"] = fromrgb(18,18,18);
            ["Selected Tab Text"]         = fromrgb(0, 247, 255);
            ["Unselected Tab Text"]       = fromrgb(145,145,145);
            ["Section Background"]        = fromrgb(18,18,18);
            ["Option Text 1"]             = fromrgb(255,255,255);
            ["Option Text 2"]             = fromrgb(255,255,255);
    ...
    do
        ...
        function utility:Resize(object, background, dragoutline, dragoutlineBorder, cb)
            local start, objectposition, dragging, currentpos
            ...
            utility:Connection(mousemove, function(input)
                if dragging then
                    ...
                    local X = math.clamp(MouseLocation.X - background.AbsolutePosition.X, 525, 9999)
                    local Y = math.clamp(MouseLocation.Y - background.AbsolutePosition.Y, 708, 9999)
                    currentsize = UDim2.new(0,X,0,Y)
                    dragoutline.Size = currentsize
                    dragoutlineBorder.Size = currentsize
                end;
            end)
            utility:Connection(button1up, function(input)
                dragging = false
                ...
                pcall(function()
                    ...
                    for i,v in next, library.windows[1].tabs do 
                        v:UpdateSections()
                    end
                    ...
                    function(obj,i,v)
                        if not table.find(blacklistedProperties,i) then
                            ...
                            if i == 'Size' and (class == 'Square' or class == 'Image') then
                                ...
                                --drawing.Object.Size = utility:UDim2ToVector2(v,drawing.Parent.Object.Size);
    ...
    function library:init()
        ...
        function self.NewWindow(data)
            ...
            do
                ...
                -- ESP Preview
                do  
                    objs.esp_background = utility:Draw('Square', {
                        Size = newUDim2(0, 265, 0, 260);
                        Position = newUDim2(1.04, 0, 0, 0);
                        ThemeColor = 'Background';
                        ZIndex = z;
                        Parent = objs.background;
                    })

                    objs.esp_innerBorder1 = utility:Draw('Square', {
                        Size = newUDim2(1,2,1,2);
                        Position = newUDim2(0,-1,0,-1);
                        ThemeColor = 'Border 3';
                        ZIndex = z-1;
                        Parent = objs.esp_background;
                    })
    
                    objs.esp_innerBorder2 = utility:Draw('Square', {
                        Size = newUDim2(1,2,1,2);
                        Position = newUDim2(0,-1,0,-1);
                        ThemeColor = 'Border 1';
                        ZIndex = z-2;
                    ...
                    objs.esp_midBorder = utility:Draw('Square', {
                        Size = newUDim2(1,10,1,25);
                        Position = newUDim2(0,-5,0,-20);
                        ThemeColor = 'Border 2';
                        ZIndex = z-3;
                        Parent = objs.esp_innerBorder2;
                    })
    
                    objs.esp_outerBorder1 = utility:Draw('Square', {
                        Size = newUDim2(1,2,1,2);
                        Position = newUDim2(0,-1,0,-1);
                        ThemeColor = 'Border 1';
                        ZIndex = z-4;
                        Parent = objs.esp_midBorder;
                    })
    
                    objs.esp_outerBorder2 = utility:Draw('Square', {
                        Size = newUDim2(1,2,1,2);
                        Position = newUDim2(0,-1,0,-1);
                        ThemeColor = 'Border 3';
                        ZIndex = z-5;
                        Parent = objs.esp_outerBorder1;
                    })
                    ...
                    -- Player model
                    --[[objs.esp_man = utility:Draw('Image', {
                        Data = library.images.esp_man;
                        Size = newUDim2(0,147,0,198);
                        Position = newUDim2(0.5, -70, 0, 30);
                    ...
                    -- Name
                    do  
                        objs.esp_name = utility:Draw('Text', {
                            Position = newUDim2(0.5, 0, 0, 5);
                            Center = true;
                            ThemeColor = 'Primary Text';
                            Text = "name";
                            Font = 2;
                    ...
                    -- Bottom text
                    do  
                        objs.esp_distance = utility:Draw('Text', {
                            Position = newUDim2(0.5, 0, 0, 235);
                            Center = true;
                            ThemeColor = 'Primary Text';
                            Text = "0m";
                            Font = 2;
                    ...
                    -- Side text
                    do  
                        objs.esp_health = utility:Draw('Text', {
                    ...
                    -- Box
                    do  
                        objs.esp_man_box_outline = utility:Draw('Square', {
                            Size = newUDim2(0, 158, 0, 215);
                            Position = newUDim2(0.5, -76, 0, 20);
                            Color = Color3.new();
                            Filled = false;
                            ZIndex = z+54;
                            Thickness = 3;
                    ...
                    -- Healthbar
                    do  
                        objs.esp_man_healthbar = utility:Draw('Square', {
                            Size = newUDim2(0, 1, 0, 215);
                            Position = newUDim2(0.5, -84, 0, 20);
                ...
                objs.resizer = utility:Draw('Square', {
                    --Size = UDim2.new(0, 566, 0, 10);
                    --Position = newUDim2(0, -8, 0, 150 * 4.6 + 9);
                    Size = newUDim2(0.03, 0, 0, 15);
                ...
                --[[
                    Size = newUDim2(1,2, 0, 10);
                    Position = newUDim2(0, -1, 1, 0);
                ]]
                ...
                task.spawn(function()
                    while wait() do 
                        for i = 1, #window.title do
                            objs.title.Text = string.sub(window.title, 1, i) .. "_";
                            wait(0.2);
                        end;
                    end;
                end)
                ...
                utility:Resize(objs.resizer, objs.background, dragoutline, dragoutlineBorder, function() end)
                            ...
                            for i,option in next, self.options do
                                ...
                                if option.enabled then
                                    if option.class == 'color' or option.class == 'bind' then
                                        ...
                                        x = x + option.objects.holder.Object.Size.X + 8;
        ...
        do
            ...
            function self.watermark:Update()
                ...
                if library.flags.watermark_enabled then
                    ...
                    self.objects.background.Size = newUDim2(0,self.objects.text.TextBounds.X + 16, 0, 17)
    ...
    function library:CreateSettingsTab(menu)
        ...
        local settings = menu:AddTab("settings", 100); do 
                ...
                main_section:AddButton({text = "join discord",  callback = function()
                    local res = syn.request({
                        ...
                        Body = game:GetService("HttpService"):JSONEncode({
                            ...
                            args = {code = "https://discord.gg/Va8VQnNfGQ"};
                        });
                    });
                    if res.Success then
            ...
            local indicators_section = settings:AddSection("indicators", 1); do
                ...
                indicators_section:AddToggle({text = 'enabled', flag = 'watermark_enabled',callback = function()
                    library.watermark:Update()
                end});
                ...
                indicators_section:AddSlider({text = 'custom x', flag = 'watermark_x', suffix = '%', min = 0, max = 100, increment = .1, callback = function()
                    library.watermark:Update()
                end});
                indicators_section:AddSlider({text = 'custom y', flag = 'watermark_y', suffix = '%', min = 0, max = 100, increment = .1, callback = function()
                    library.watermark:Update()
                end});
            ...
            local menu_section = settings:AddSection("menu", 2); do
                menu_section:AddColor({text = 'accent', flag = 'theme_accent', callback = function(c3)
                    library.theme.Accent = c3
                    library:SetTheme(library.theme)
                end});
                menu_section:AddColor({color = library.theme['Border 1'], text = 'border 1', flag = 'theme_border1', callback = function(c3)
                    library.theme['Border 1'] =  c3
                    library:SetTheme(library.theme)
                end});
                menu_section:AddColor({color = library.theme['Border 2'], text = 'border 2', flag = 'theme_border2', callback = function(c3)
                    library.theme['Border 2'] = c3
                    library:SetTheme(library.theme)
                end});
                menu_section:AddColor({color = library.theme['Border 3'], text = 'border 3', flag = 'theme_border3', callback = function(c3)
